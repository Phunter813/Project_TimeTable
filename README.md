...
> A simple little hack to get your updated TIME TABLE , at just one click.  
> the code has been written in Python 3.5.2 so its self.
> explanatory that your machine should've got python installed in it, here it is.
...
pause
```
PATH will be the place where you have all your python programs, or where your projrcts are being saved, mine looks like this 'D:\PycharmProjects\dictionary' for that just right click on the python file and click on properties and paste the get the path .
